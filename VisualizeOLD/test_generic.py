...
class TestGeneric(TestCase):
    def setUp(self):
        ...
        self.Plot = VisualizeOLD.base.Generic(self.sample)
    ...
    def test___treatment_variable_transformation(self):
        ...
        ddict = self.Plot._treatment_variable_transformation(self.Plot.sample_group.sample_list[0], mtype='thellier',
                                                             ttype='pressure')
    ...
    def add_measurements_treatments(self):
        ...
        folder = '../tutorials.rst/test_data/treatments'
